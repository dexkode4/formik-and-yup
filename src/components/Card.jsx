...
function CardContainer({ children, cardContainerRef, index, setIndex }) {
    const cardHeight = 23;
    let numberOfCards = 4;
    let current = 1;
                ...
                <div className="flex justify-between items-center mb-12">
                        ...
                        <div className="flex justify-between w-max">
                            <div>
                                ...
                                <label htmlFor="self-delivering" className="flex flex-col items-center cursor-pointer card-svg">
                                    <WalkingIcon />
                            ...
                            <div>
                                ...
                                <label htmlFor="tailor-pickup" className="flex flex-col items-center cursor-pointer card-svg">
                        ...
                        <div className="flex">
                            ...
                            <div className="w-full">
                                ...
                                <div className="flex w-full mt-4">
                                    <LocationIcon />
                                    <input type="text" className="bg-gray-200 ml-3 rounded-md w-full outline-none px-3 " />
                                </div>
                            </div>
                        </div>
                    </div>
